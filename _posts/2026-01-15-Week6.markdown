...
<img width="300" alt="preview of upgrade effects" src="{{ '/images/upgrade-preview.png' | relative_url }}">
...
<img width="300" alt="inventory with item information" src="{{ '/images/inventory-item-info.png' | relative_url }}">
