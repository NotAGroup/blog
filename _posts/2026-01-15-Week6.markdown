...
The Door is functional meaning it has an modelis rigged and has animation.
Next are some improvments of the material.
Also i want to import it into unity so we can inegrated it into the dungeon creation and test it.

With the hope that i can later change the model and textures.

![]({{site.imgpath}}/boss-door-unity-1.png){: height="250ex"}
...
<img width="300" alt="Boss_v1" src="{{site.imgpath}}/Boss_v1.png">
...
<img width="300" alt="Slime_divide" src="{{site.imgpath}}/Slime_divide.gif">
<img width="300" alt="Slime_particle" src="{{site.imgpath}}/Slime_particle.gif">
