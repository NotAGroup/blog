...
All slime animation is shader ogram calculated instead of skeletton animation.
...
When player has no more arrow, there is no dummu arrow when drawing the bow, which can notify player, that your quiver is empty now.
