...
Interacting with the trapdoor after clearing the level takes the player to the next level (simply incrementing the level and reloading the scene).
A level counts as completed after all enemies have been eliminated.
...
The persistent data is registered to the game saving system.
...
Other small contributions: Improved gamepad input for UIs and camera movement. Added the assets for table and trapdoor to the respective prefabs.
