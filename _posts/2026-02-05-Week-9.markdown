...
Experimented with enabling/disabling torches depending on the players 
position as we currently have a high number of light sources 
(unity gives out warnings about it being to high for the given shadow
atlas size).
