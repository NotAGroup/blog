...
<video width="600" alt="lighting based on torches with flickering effect" src="{{ '/images/torches.mp4' | relative_url }}">
...
<video width="600" alt="arrows sticking to opponent" src="{{ '/images/sticking-arrows.mp4' | relative_url }}">
